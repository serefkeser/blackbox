...
const FILE = path.join(__dirname, 'black.3.7.jsx');
...
t('APP_VERSION hotfix=H3.7', /hotfix:\s*['"]H3\.7['"]/.test(src));
...
t('Version history has black_3.7', /black_3\.7\s*\(black\.3\.7\)/.test(src));
t('Last line says black_3.7', /OTONOM black_3\.7/.test(src));
...
// ═══ RESULTS ═══
console.log('═══════════════════════════════════════════════════════════════');
console.log(`  black.3.7.jsx (black_3.7) TEST RESULTS: ${pass} PASS / ${fail} FAIL / ${pass+fail} TOTAL`);
console.log('═══════════════════════════════════════════════════════════════');
...
if (fail > 0) {
  ...
  console.log(`  ✅ TÜM TESTLER BAŞARILI — black.3.7.jsx (black_3.7) ONAYLANDI`);
  process.exit(0);
}
