...
const FILE = path.join(__dirname, 'black.3.6.jsx');
...
t('APP_VERSION hotfix=H3.6', /hotfix:\s*['"]H3\.6['"]/.test(src));
...
// v3.6 version history comments
t('Version history has black_3.6', /black_3\.6\s*\(black\.3\.6\)/.test(src));
t('Last line says black_3.6', /OTONOM black_3\.6/.test(src));

// ═══ RESULTS ═══
console.log('═══════════════════════════════════════════════════════════════');
console.log(`  black.3.6.jsx (black_3.6) TEST RESULTS: ${pass} PASS / ${fail} FAIL / ${pass+fail} TOTAL`);
console.log('═══════════════════════════════════════════════════════════════');
...
if (fail > 0) {
  ...
  console.log(`  ✅ TÜM TESTLER BAŞARILI — black.3.6.jsx (black_3.6) ONAYLANDI`);
  process.exit(0);
}
