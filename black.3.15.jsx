...
const convertWebMtoMP4 = async (webmBlob, onProgress) => {
  ...
  await ffmpeg.run('-i', 'input.webm', '-vf', 'fps=30', '-r', '30', '-vsync', 'cfr', '-c:v', 'libx264', '-preset', 'fast', '-pix_fmt', 'yuv420p', '-c:a', 'aac', '-b:a', '128k', '-movflags', '+faststart', 'output.mp4');
...
// OTONOM black_3.15 — Gemini Canvas uyumlu versiyon
