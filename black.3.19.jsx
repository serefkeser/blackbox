...
const ALLOWED_GAZETELER = [
  ...
  'Dünya', 'Evrensel', 'Fanatik', 'Fotomaç', 'Karar', 'Korkusuz',
  'Milat', 'Milli Gazete', 'Nasıl Bir Ekonomi', 'Nefes', 'Posta',
  ...
  render() {
    ...
    return this.props.children;
            ...
            export default function App() {
              ...
              // 26 Özel İzinli Ulusal Gazete Mimarisi (Doğrudan Yüksek Çözünürlüklü CDN Haritası)
              ...
              // 27 Ulusal Gazetenin ilk sayfalarını %100 doğrudan ve CORS-free getiren fonksiyon
              const fetchGazeteManşetleri = async () => {
                setGazeteLoading(true);
                setGazeteError('');
                setGazeteItems([]);
                addSystemLog('27 Ulusal gazete manşeti hazırlanıyor...', 'info');
                ...
                try {
                  ...
                  addSystemLog(`✓ 27 ulusal gazete manşetinin tamamı (Gazete Pencere dahil) 0 CORS hatası ile hazırlandı!`, 'success');
                } catch (e) {
              ...
              const matchOrFormatGazeteName = (rawName) => {
                ...
                const GAZETE_LIST = [
                  'Akşam', 'Analiz', 'Aydınlık', 'BirGün', 'Cumhuriyet', 'Diriliş Postası',
                  'Dünya', 'Evrensel', 'Fanatik', 'Fotomaç', 'Gazete Pencere', 'Karar', 'Korkusuz',
                  'Milat', 'Milli Gazete', 'Nasıl Bir Ekonomi', 'Nefes', 'Posta',
                  'Sabah', 'Sözcü', 'Takvim', 'Tavır Gazetesi', 'Türkiye', 'Yeniçağ', 'Yeni Asya',
                  'Yeni Birlik', 'Yeni Şafak'
                ];
                const lower = rawName.toLowerCase();
                // 1. Resmi 27 ulusal gazete listesinden tam eşleştirme
                ...
                {activeTab === 'gazete' && (
                    ...
                    <div className="flex items-center justify-between gap-2 mb-3 flex-wrap bg-slate-950/40 p-2.5 rounded-xl border border-slate-800">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs md:text-sm font-black text-white tracking-wide">Ulusal Gazete Manşetleri (27 Gazete)</span>
                      </div>
                      <div className="flex items-center gap-2">
...
// OTONOM black_3.19 — Gemini Canvas uyumlu versiyon
