...
t('v3.23: Prompt has ADIM 4 DOĞRULAMA', /ADIM 4.*DO\u011eRULAMA/.test(src));
t('v3.23: Prompt has ADIM 5 VİDEO SENARYOSU', /ADIM 5.*V\u0130DEO SENARYOSU/.test(src));
t('v3.23: Schema has gercekNeOluyor field', /gercekNeOluyor.*type.*STRING/.test(src));
t('v3.23: Schema has gercekNeOluyorImagePrompt field', /gercekNeOluyorImagePrompt.*type.*STRING/.test(src));
t('v3.23: Schema requires gercekNeOluyor', /required.*gercekNeOluyor/.test(src));
