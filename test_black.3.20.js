...
const FILE = path.join(__dirname, 'black.3.20.jsx');
...
t('APP_VERSION minor=20', /APP_VERSION\s*=\s*\{[\s\S]*?minor:\s*20[,\s]/.test(src));
t('APP_VERSION hotfix=H3.20', /hotfix:\s*['"]H3.20['"]/.test(src));
...
t('Last line says black_3.20', /OTONOM black_3.20/.test(src));
...
t('v3.11: Last line says black_3.20', /OTONOM black_3.20/.test(src));
...
t('v3.12: APP_VERSION minor is 20', /minor:\s*20/.test(src));
t('v3.12: APP_VERSION hotfix is H3.20', /hotfix:\s*'H3.20'/.test(src));
...
t('v3.12: Last line says black_3.20', /OTONOM black_3\.20/.test(src));

// ═══ v3.13: Audio Bleed + Altyazı + Chart Overlay + Split-Screen + Watermark ═══
t('v3.13: APP_VERSION minor is 20', /minor:\s*20/.test(src));
t('v3.13: APP_VERSION hotfix is H3.20', /hotfix:\s*'H3.20'/.test(src));
...
t('v3.13: Version history has black_3.13 entry', /black_3.20/.test(src));
t('v3.13: Version history mentions Audio Bleed', /black_3.20[\s\S]*?Audio Bleed/.test(src));
t('v3.13: Last line says black_3.20', /OTONOM black_3\.20/.test(src));

// ═══ v3.14: Müzik Seçim Bug Fix ═══
t('v3.14: APP_VERSION minor is 20', /minor:\s*20/.test(src));
t('v3.14: APP_VERSION hotfix is H3.20', /hotfix:\s*'H3.20'/.test(src));
...
t('v3.14: Last line says black_3.20', /OTONOM black_3\.20/.test(src));

// ═══ v3.15: Instagram FPS Fix (VFR→CFR + WebM→MP4) ═══
t('v3.15: APP_VERSION minor is 20', /minor:\s*20/.test(src));
t('v3.15: APP_VERSION hotfix is H3.20', /hotfix:\s*'H3.20'/.test(src));
...
t('v3.15: Last line says black_3.20', /OTONOM black_3\.20/.test(src));

// ═══ v3.16: Export Progress Feedback + Granular ffmpeg Error Handling ═══
t('v3.16: APP_VERSION minor is 20', /minor:\s*20/.test(src));
t('v3.16: APP_VERSION hotfix is H3.20', /hotfix:\s*'H3.20'/.test(src));
...
t('v3.16: Last line says black_3.20', /OTONOM black_3\.20/.test(src));
...
// Version history
t('v3.18: Version history has black_3.18 entry', /black_3.20/.test(src));
t('v3.18: Version history mentions Render Resume', /black_3.20[\s\S]*?Render Resume/i.test(src));
t('v3.18: Version history mentions SRT', /black_3.20[\s\S]*?SRT/i.test(src));
t('v3.18: Version history mentions Batch Queue', /black_3.20[\s\S]*?Batch/i.test(src));
t('v3.18: Last line says black_3.20', /OTONOM black_3.20/.test(src));
...
// Version history
t('v3.18: Version history has black_3.20 entry', /black_3\.20/.test(src));
t('v3.18: Last line says black_3.20', /OTONOM black_3\.20/.test(src));
...
t('v3.20: Version history has black_3.20 entry', /black_3\.20/.test(src));
t('v3.20: Last line says black_3.20', /OTONOM black_3\.20/.test(src));
...
console.log(`  black.3.20.jsx (black_3.20) TEST RESULTS: ${pass} PASS / ${fail} FAIL / ${pass+fail} TOTAL`);
console.log('═══════════════════════════════════════════════════════════════');
...
if (fail > 0) {
  ...
  console.log(`  ✅ TÜM TESTLER BAŞARILI — black.3.20.jsx (black_3.20) ONAYLANDI`);
  process.exit(0);
}
