...
const FILE = path.join(__dirname, 'black.3.11.jsx');
...
t('APP_VERSION minor=11', /APP_VERSION\s*=\s*\{[\s\S]*?minor:\s*11[,\s]/.test(src));
t('APP_VERSION hotfix=H3.11', /hotfix:\s*['"]H3.11['"]/.test(src));
...
t('Last line says black_3.11', /OTONOM black_3.11/.test(src));
...
t('v3.11: Last line says black_3.11', /OTONOM black_3.11/.test(src));
...
// ═══ RESULTS ═══
console.log('═══════════════════════════════════════════════════════════════');
console.log(`  black.3.11.jsx (black_3.11) TEST RESULTS: ${pass} PASS / ${fail} FAIL / ${pass+fail} TOTAL`);
console.log('═══════════════════════════════════════════════════════════════');
...
if (fail > 0) {
  ...
  console.log(`  ✅ TÜM TESTLER BAŞARILI — black.3.11.jsx (black_3.11) ONAYLANDI`);
  process.exit(0);
}
