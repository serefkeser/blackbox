...
const FILE = path.join(__dirname, 'black.3.15.jsx');
...
t('APP_VERSION minor=15', /APP_VERSION\s*=\s*\{[\s\S]*?minor:\s*15[,\s]/.test(src));
t('APP_VERSION hotfix=H3.15', /hotfix:\s*['"]H3.15['"]/.test(src));
...
t('Last line says black_3.15', /OTONOM black_3.15/.test(src));
...
t('v3.11: Last line says black_3.15', /OTONOM black_3.15/.test(src));
...
t('v3.12: APP_VERSION minor is 15', /minor:\s*15/.test(src));
t('v3.12: APP_VERSION hotfix is H3.15', /hotfix:\s*'H3.15'/.test(src));
...
t('v3.12: Last line says black_3.15', /OTONOM black_3.15/.test(src));

// ═══ v3.13: Audio Bleed + Altyazı + Chart Overlay + Split-Screen + Watermark ═══
t('v3.13: APP_VERSION minor is 15', /minor:\s*15/.test(src));
t('v3.13: APP_VERSION hotfix is H3.15', /hotfix:\s*'H3.15'/.test(src));
...
t('v3.13: Last line says black_3.15', /OTONOM black_3.15/.test(src));

// ═══ v3.14: Müzik Seçim Bug Fix ═══
t('v3.14: APP_VERSION minor is 15', /minor:\s*15/.test(src));
t('v3.14: APP_VERSION hotfix is H3.15', /hotfix:\s*'H3\.15'/.test(src));
...
t('v3.14: Last line says black_3.15', /OTONOM black_3\.15/.test(src));

// ═══ v3.15: Instagram FPS Fix (VFR→CFR + WebM→MP4) ═══
t('v3.15: APP_VERSION minor is 15', /minor:\s*15/.test(src));
t('v3.15: APP_VERSION hotfix is H3.15', /hotfix:\s*'H3\.15'/.test(src));
...
t('v3.15: Last line says black_3.15', /OTONOM black_3\.15/.test(src));

// ═══ RESULTS ═══
console.log('═══════════════════════════════════════════════════════════════');
console.log(`  black.3.15.jsx (black_3.15) TEST RESULTS: ${pass} PASS / ${fail} FAIL / ${pass+fail} TOTAL`);
console.log('═══════════════════════════════════════════════════════════════');
...
if (fail > 0) {
  ...
  console.log(`  ✅ TÜM TESTLER BAŞARILI — black.3.15.jsx (black_3.15) ONAYLANDI`);
  process.exit(0);
}
