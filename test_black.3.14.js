...
const FILE = path.join(__dirname, 'black.3.14.jsx');
...
t('APP_VERSION minor=14', /APP_VERSION\s*=\s*\{[\s\S]*?minor:\s*14[,\s]/.test(src));
t('APP_VERSION hotfix=H3.14', /hotfix:\s*['"]H3.14['"]/.test(src));
...
t('Last line says black_3.14', /OTONOM black_3.14/.test(src));
...
t('v3.11: Last line says black_3.14', /OTONOM black_3.14/.test(src));
...
t('v3.12: APP_VERSION minor is 14', /minor:\s*14/.test(src));
t('v3.12: APP_VERSION hotfix is H3.14', /hotfix:\s*'H3\.14'/.test(src));
...
t('v3.12: Last line says black_3.14', /OTONOM black_3\.14/.test(src));

// ═══ v3.13: Audio Bleed + Altyazı + Chart Overlay + Split-Screen + Watermark ═══
t('v3.13: APP_VERSION minor is 14', /minor:\s*14/.test(src));
t('v3.13: APP_VERSION hotfix is H3.14', /hotfix:\s*'H3\.14'/.test(src));
...
t('v3.13: Last line says black_3.14', /OTONOM black_3\.14/.test(src));

// ═══ v3.14: Müzik Seçim Bug Fix ═══
t('v3.14: APP_VERSION minor is 14', /minor:\s*14/.test(src));
t('v3.14: APP_VERSION hotfix is H3.14', /hotfix:\s*'H3\.14'/.test(src));
...
t('v3.14: Last line says black_3.14', /OTONOM black_3\.14/.test(src));

// ═══ RESULTS ═══
console.log('═══════════════════════════════════════════════════════════════');
console.log(`  black.3.14.jsx (black_3.14) TEST RESULTS: ${pass} PASS / ${fail} FAIL / ${pass+fail} TOTAL`);
console.log('═══════════════════════════════════════════════════════════════');
...
if (fail > 0) {
  ...
  console.log(`  ✅ TÜM TESTLER BAŞARILI — black.3.14.jsx (black_3.14) ONAYLANDI`);
  process.exit(0);
}
